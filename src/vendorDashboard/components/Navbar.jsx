    ...
    <Wrapper>
      <div className="navbar px-3 py-2 flex justify-between h-[80px] w-[80%] mx-auto items-center text-slate-900">
        ...
        <div className="right flex gap-5">
          ...
          <span className='flex items-center'><FaOpencart className='mr-1' /><span>Cart</span></span>
        </div>
      </div>
          ...
          {isLogin ? (
            <div className='login h-[680px]'>
              <div className="form">
                ...
                <button onClick={toggleAuth}><span>register</span></button>
              </div>
            </div>
          ) : (
            <div className='register bg-red-100 h-[680px]'>
              <div className="form">
                <h1>Register</h1>
                <button onClick={toggleAuth}><span>login</span></button>
              </div>
            </div>
          )}
        </div>
...
`;
const LoginForm = styled.div.Form`
h1 {
