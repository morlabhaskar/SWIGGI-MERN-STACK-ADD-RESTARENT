          ...
          {isLogin ? (
            <div className='login h-[680px] flex justify-center items-center w-[100%]'>
              ...
              >
                ...
                >
                  <Input placeholder="Enter your Email" autoComplete="new-email" className='w-[250px] mt-3 border-orange-400 ' />
                </Form.Item>
                ...
                >
                  <Input.Password placeholder="Enter your Password" autoComplete="new-password" className='w-[250px] mt-3 border-orange-400' />
                </Form.Item>
                <span>Don't Have an Account please <button onClick={toggleAuth} className='text-blue-700'>register</button></span>
                <Form.Item
                >
                  <Button className='bg-orange-600 w-[250px] mt-3 rounded-none text-white'>
                    Login
                  </Button>
                </Form.Item>
              </Form>
            ...
            <div className='login h-[680px] flex justify-center items-center w-[100%]'>
              ...
              >
                ...
                <Form.Item
                  name="name"
                >
                  <Input placeholder="Enter your Name" autoComplete="new-name" className='w-[250px] mt-3 border-orange-400 ' />
                </Form.Item>
